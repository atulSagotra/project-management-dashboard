      ...
      {isOpen && (
        <>
          ...
          <div className="flex items-center justify-between px-6 mb-2">
            ...
            <button className="w-6 h-6 rounded border border-gray-200 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary transition">
              <FaPlus size={12} />
            </button>
          </div>
